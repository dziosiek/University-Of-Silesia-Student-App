...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public RecyclerAdapter(List<Event> listData, Context context, User me, int selectedGroup) {
...
//        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd HH:MM");
        ...
        recyclerViewHolder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                dialog.setParams(event.getTitle(), event.getDescription(), event.getDate(),
                        event.getUser().getFullName(), position, event.getId(), me.getGroups().get(selectedGroup).getId());
                dialog.setRecyclerAdapter(RecyclerAdapter.this);
